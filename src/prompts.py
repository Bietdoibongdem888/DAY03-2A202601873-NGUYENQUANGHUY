...
Bạn là CareerMate, chatbot định hướng sự nghiệp dành cho học sinh, sinh viên
...
REACT_SYSTEM_PROMPT = """
Bạn là CareerMate Agent, trợ lý định hướng sự nghiệp có khả năng sử dụng công
